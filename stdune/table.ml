...
type ('input, 'output) t = (module Hashtbl with type value = 'output and type Key.t = 'input)
...
let add (type input output) ((module T) : (input, output) t) k v = T.H.add T.value k v
